 ...
 public:
  ...
  void InferShape(framework::InferShapeContext *ctx) const override {
    ...
    PADDLE_ENFORCE_EQ(inputs_dims[0].size(), 2,
        "Only supports 2-D array with batch size in the 1st dimension and data in the 2nd.");
 ...
 public:
  void Make() override {
    ...
    AddAttr<int>("start_index",
        ...
        .SetDefault(0);
    AddAttr<int>("length", "The length of each instance for concatenation."
        " Negative values for all elements after start_index") .SetDefault(-1);
    AddComment(R"DOC(
...
REGISTER_OP_WITHOUT_GRADIENT(partial_concat, ops::PartialConcatOp, ops::PartialConcatOpMaker);
REGISTER_OP_CPU_KERNEL(
    partial_concat, ops::PartialConcatKernel<paddle::platform::CPUDeviceContext, double>,
